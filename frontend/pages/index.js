...
export default function Dashboard(props) {
  ...
  async function wakeUp() {
    ...
    while (attemptCount <= 20) {
      console.log(`Making attempt ${attemptCount} to wake up API...`);
      try {
  ...
  useEffect(() => {
    ...
    if (socket) {
      ...
      const username = !props?.user_data?.user[0] ? null : props?.user_data?.user[0]?.username;
  ...
  return (
    <div className="flex flex-col bg-gray-800">
      {props?.user_data == null ? (
        <div className="text-black bg-white text-5xl">
          <h1>
            Hello, Sorry for this issue, I am using free tier of onrender.com so
                  ...
                  <div className="flex items-center">
                    <div className="flex items-center ml-3">
                      <div>
                        ...
                        >
                          <span className="sr-only">Open user menu</span>
                          <div className="relative w-10 h-10 overflow-hidden bg-transparent rounded-full "></div>
                        </div>
                      </div>
                    </div>
                  </div>
